...
"""
Process HLS algorithm on Landsat-5 collection 1 level 1 images. One directory is mandatory : result of LaSRC algorithm. 
...
def coregistration(directory_LaSRC, directory_workspace, translation_latitude, translation_longitude, file):
    ...
    for name in list_band:
        ...
        #rasterio.Affine object for final position of Landsat 5 images
...
#Create workspace in output_image
